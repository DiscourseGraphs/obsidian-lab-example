...
----
#### New Today
- [ ] add tasks here — use a #tag prefix to track them and set a due date using the 📅 icon YYYY-MM-DD
- [ ] 
- [ ] 
----
## Daily Log
...
----
### 🧪 Experiment Log
- #🧪ExperimentLog:: need more coconuts #iss-candidate [[@analysis - measure airspeed of unladen & laden AFR & EUR swallows]]
----
## Projects
